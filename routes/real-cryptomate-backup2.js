...
// Convertir transacciones de CryptoMate a formato Nano (ACTUALIZADA CON OPERATION)
...
// Endpoint para importar transacciones de una tarjeta específica (ACTUALIZADO CON OPERATIONS)
        ...
        for (const cryptoTransaction of cryptoTransactions) {
          try {
            ...
            if (!existingTransaction) {
              ...
              console.log(`✅ Imported transaction: ${nanoTransaction._id} - ${nanoTransaction.name} (${nanoTransaction.operation})`);
            } else {
              // Actualizar transacción existente
              Object.assign(existingTransaction, nanoTransaction);
              await existingTransaction.save();
              updatedTransactions++;
              console.log(`🔄 Updated transaction: ${nanoTransaction._id} - ${nanoTransaction.name} (${nanoTransaction.operation})`);
            }

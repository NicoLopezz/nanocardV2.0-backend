...
async function migrateManualDeposits() {
  try {
    console.log('🚀 Iniciando migración de depósitos manuales desde bkp_old_db...');
            ...
            try {
              ...
              const transactionData = {
                ...
                history: [{
                  ...
                  timestamp: new Date(),
                  modifiedBy: 'system',
                  reason: 'Migrated from bkp_old_db'
                }]
              };
              ...
              console.log(`    ✅ Creada transacción ${transactionId} por $${recarga.monto} (${recarga.fecha})`);
...
module.exports = { migrateManualDeposits };
